...
import post1 from '../../assets/Home/sc4.png'
import post2 from '../../assets/Home/sc3.png'
import post3 from '../../assets/Home/sc2.png'
...
export const ArchivePosts = () => {
    return (
        <div className="mx-[2rem] py-8 text-white">
            <h1 className="text-4xl text-center font-bold mb-4">Recent Posts</h1>
